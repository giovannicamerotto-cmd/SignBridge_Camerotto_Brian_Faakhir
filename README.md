...
* on a terminal run ```& ".\.venv310\Scripts\python.exe" app.py``` or you can download the latest `.zip` from the **GitHub Releases** page, extract it, and double-click the `.exe` to run the application immediately without configuring a Python environment. 
